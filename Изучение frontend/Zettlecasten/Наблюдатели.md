...
###### Links: 
1) [[Чистые функции]]
2) [[Глубокие наблюдатели]]
3) [[Нетерпеливые и единичные наблюдатели]]
4) [[watchEffect]]
5) [[Очистка от побочных эффектов]]
6) [[Время обратного вызова в наблюдателях]]
7) [[Остановка наблюдателя]]
# Заметка
