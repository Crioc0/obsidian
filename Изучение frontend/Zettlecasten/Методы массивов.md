...
Поэтому typeof не может отличить простой объект от массива. Для массивов есть специальный метод Array.isArray(value), который возвращает true, если value это массив
