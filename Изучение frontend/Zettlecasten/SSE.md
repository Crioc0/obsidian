...
2) Сервер настравивает ответ: 
	1) Устанавливает заголовок `Content-type: text/event-stream`
	2) Поддерживает постоянное HTTP-соединение
	3) Отправляет данные в формате ```javasci```
